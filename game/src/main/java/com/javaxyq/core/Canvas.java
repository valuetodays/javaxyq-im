...
//            try {
//                ImageIO.write(offscreenImage, "png", new java.io.File("f:/tmp/aa/" + System.currentTimeMillis() + ".png"));
//            } catch (IOException e) {
//                e.printStackTrace();
//            }
            //logger.debug(">> offscreenImage:" + offscreenImage.hashCode());
...
//		lastTime = System.currentTimeMillis();
    ...
    protected void drawComponents(Graphics g, long elapsedTime) {
        ...
        // TODO [test For image start]
//        Image image = ((Label) ((Panel) (comps[0])).getComponent(8)).getAnim().getCurrFrame().getImage();
//
//        try {
//            ImageIO.write((BufferedImage)image, "png", new java.io.File("f:/tmp/aa/" + System.currentTimeMillis() + ".png"));
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
        // TODO [test For image end]
